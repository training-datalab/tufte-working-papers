...
\captionsetup[subfigure]{labelformat=empty}
  ...
  \subfloat[VB2]{\includegraphics[width=.30\linewidth]{figures/log-OR-part}}
  \subfloat[PROT3]{\includegraphics[width=.30\linewidth]{figures/log-OR-prot}}
  \subfloat[EFF1]{\includegraphics[width=.30\linewidth]{figures/log-OR-eff}}\\
   \subfloat[VB10]{\includegraphics[width=.30\linewidth]{figures/log-OR-id-part}}
   \subfloat[POL1]{\includegraphics[width=.30\linewidth]{figures/log-OR-int}}
   \subfloat[GI0]{\includegraphics[width=.30\linewidth]{figures/log-OR-medios}}
  \\ \smallskip\noindent\scriptsize Fuente: Elaboración propia con datos del Barómetro de las Américas 2016/17 por LAPOP, \href{https://www.vanderbilt.edu/lapop/}{\textcolor{blue}{www.LapopSurveys.org}}.
\end{figure*}

\justify{La propensión para las distintas variables de participación y compromiso político están expresadas en los efectos fijos de los modelos de efectos mixtos: participación electoral ($\beta_0$ = -1,423; CI95\% = -1,739; -1,107), en protestas ($\beta_0$ = -2,869; CI95\% = -3,139; -2,600), eficacia política ($\beta_0$ = -0,516; CI95\% = -0,686; -0,346), identificación partidaria ($\beta_0$ = -2,496; CI95\% = -2,805; -2,186), interés en la política (($\beta_0$ = -1,664; CI95\% = -1,838; -1,491) y consumo de medios ($\beta_0$ = -1,552; CI95\% = -1,722; -1,383). Todos altamente significativos (p = 0,000).}

\justify{Al efecto fijo se añade la perturbación aleatoria entre los distintos países que presenta las siguientes varianzas: participación electoral ($\sigma_{u}^{2}$ = 0,414; CI95\% = 0,218; 0,786), en protestas ($\sigma_{u}^{2}$ = 0,216; CI95\% = 0,111; 0,423), eficacia política ($\sigma_{u}^{2}$ = 0,088; CI95\% = 0,046; 0,170), identificación partidaria ($\sigma_{u}^{2}$ = 0,399; CI95\% = 0,209; 0,761), interés en la política ($\sigma_{u}^{2}$ = 0,087; CI95\% = 0,045; 0,169) y consumo de medios ($\sigma_{u}^{2}$ = 0,084; CI95\% = 0,044; 0,162). Además, todas las pruebas de contraste entre efectos fijos y aleatorios fueron estadísticamente significativas de forma robusta (p = 0,000).}

\justify{A continuación, en el gráfico 6, se representan los efectos del nivel país para cada modelo de efectos mixtos, los cuales ratifican las tendencias detectadas en los efectos marginales de las variables {\itshape dummies} de países en los modelos logísticos.}

\begin{figure*}[h!]
\captionsetup[subfigure]{labelformat=empty}
  \centering
  \smallskip\noindent\small Figura 6 \\ Efectos aleatorios en torno a la constante por país, América Latina 2016/17
  \subfloat[VB2]{\includegraphics[width=.30\linewidth]{figures/random-part}}
  \subfloat[PROT3]{\includegraphics[width=.30\linewidth]{figures/random-prot}}
  \subfloat[EFF1]{\includegraphics[width=.30\linewidth]{figures/random-eff}}\\
   \subfloat[VB10]{\includegraphics[width=.30\linewidth]{figures/random-id-part}}
   \subfloat[POL1]{\includegraphics[width=.30\linewidth]{figures/random-int}}
   \subfloat[GI0]{\includegraphics[width=.30\linewidth]{figures/random-medios}}
  \\ \smallskip\noindent\scriptsize Fuente: Elaboración propia con datos del Barómetro de las Américas 2016/17 por LAPOP, \href{https://www.vanderbilt.edu/lapop/}{\textcolor{blue}{www.LapopSurveys.org}}.
\end{figure*}
