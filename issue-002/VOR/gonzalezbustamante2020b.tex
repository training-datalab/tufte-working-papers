...
{\noindent González-Bustamante, B. (2021). Sofisticación, participación y compromiso político en América Latina. {\itshape Tufte Working Papers}, 2, 1--21. {\scshape doi:} \href{https://doi.org/10.5281/zenodo.6739833}{\textcolor{blue}{10.5281/zenodo.6739833}}. {\small SocArXiv:} \href{https://doi.org/10.31235/osf.io/r4pj8}{\textcolor{blue}{10.31235/osf.io/r4pj8}}.}
\pagebreak

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%% \vspace{8mm}
\section[Introducción] {{\normalfont Introducción} \footnote{Agradezco al Proyecto de Opinión Pública de América Latina (LAPOP) y a sus principales donantes (la Agencia de los Estados Unidos para el Desarrollo Internacional, el Programa de las Naciones Unidas para el Desarrollo, el Banco Interamericano de Desarrollo y Vanderbilt University) por poner a disposición los datos utilizados en este trabajo. También agradezco los comentarios de Antoine Maillet. Esta investigación fue parcialmente financiada por el Convenio de Desempeño 2018 de la Universidad de Santiago de Chile (USACH). El autor declara no tener potenciales conflictos de interés con respecto a esta investigación.}}
...
\justify{La literatura suele asociar la participación política convencional con actividades como el sufragio, la participación en partidos políticos y campañas electorales (Norris, 2009). La participación no convencional, por otra parte, se vincula a la política contenciosa de corte protestatario, la cual se ajusta al repertorio de acción colectiva disponible en un momento sociohistórico específico y está delimitada por estructuras de experiencias compartidas de aprendizaje basadas en la forma de organización de la acción colectiva (Tarrow, 2012; Tilly, 2006).  En este sentido, la ciencia política y la sociología han estudiado bastante, durante el último medio siglo, cuáles son los factores sociodemográficos y actitudinales que emergen como predictores de la participación política (Almond y Verba, 1980; Verba y Nie, 1972; Verba, Nie y Kim, 1978).}
...
\justify{Se utilizan modelos de dos niveles por cada variable dependiente: donde para una serie de $M$ clústeres independientes, en este caso las muestras nacionales, hay también un conjunto $u_j$ de efectos aleatorios (Pinheiro y Bates, 1995; Pinheiro y Chao, 2006). En el primer nivel se modelan la variable de conocimiento político y los controles, mientras que en el segundo se anidan los países. Para estos modelos solo se reporta el logaritmo de verosimilitud ({\itshape Log Likelihood}, LL) y los valores del criterio de información de Akaike (1973) ({\itshape Akaike Information Criterion}, AIC), calculado como $(-2\ln L + 2k) / N$, y el criterio de información bayesiano ({\itshape Bayesian Information Criterion}, BIC; véase Raftery, 1995), calculado con $-2\ln L + k\ln N$}. %% $D2 - (n - k) * ln (n)$
...
\justify{El primer modelo muestra que el conocimiento político aumenta la probabilidad de participar electoralmente (OR = 1,262; CI$_{95\%}$ = 1,225; 1,302), lo mismo ocurre con la edad (OR = 1,054; CI$_{95\%}$ = 1,052; 1,057). En contraste, ser hombre (OR = 0,900; CI$_{95\%}$ = 0,852; 0,951) y vivir en zonas urbanas (OR = 0,842; CI$_{95\%}$ = 0,785; 0,904) se asocian con una menor probabilidad de participar electoralmente.}
...
\justify{Este trabajo analiza la consistencia que tiene la sofisticación política en América Latina como un predictor tanto de la participación como del compromiso político individual. El documento presenta, como un elemento distintivo, las potenciales virtudes de medir el conocimiento del encuestado por parte del entrevistador, evitando así el sesgo del auto-reporte. Si bien el documento destaca este punto en la introducción, resulta crucial avanzar hacia investigaciones que tomen en consideración este tipo de mediciones. Por consiguiente, este trabajo constituye un aporte teórico y metodológico relevante más allá del estudio de las características individuales, ya sean auto-reportadas o no, y su relación con la participación y el compromiso político.}

\justify{En términos de diseño, es importante que el lector tenga en consideración que este estudio utiliza una variable independiente para explicar diversas variables dependientes con el objetivo de probar este nuevo indicador. Por otra parte, con respecto a las variables de control, para futuros estudios sería relevante considerar factores relacionados con el nivel educacional alcanzado por el entrevistado como potencial predictor en el estudio de fenómenos como el apoyo a la democracia o el interés en la política.}

\justify{En la estimación de los modelos, es importante tener en cuenta que se utiliza un predictor categórico donde los países se contrastan con Chile y se evalúa la variabilidad a nivel país con interceptos diferenciados. Por otro lado, otro punto interesante que se podría explorar en un futuro son los efectos no lineales de la variable edad que podrían afectar variables como la participación electoral. También sería interesante explorar en mayor profundidad, en la estimación de efectos aleatorios, el impacto del conocimiento en cada país.}
...
\begin{table}[h]
\begin{tabular}{@{}lll@{}}
{\small 1,0} & {\small 21 septiembre 2018} & {\small Manuscrito original} \\[0.8mm]
{\small 2,0$^\dagger$} & {\small 26 agosto 2020} & {\small Manuscrito revisado} \\[0.8mm]
{\small 3,0$^\dagger$} & {\small 31 diciembre 2021} & {\small Fecha de publicación} \\[0.8mm]
{\small 4,0$^\dagger$} & {\small 7 abril 2022} & {\small Correcciones menores} \\[0.8mm]
{\small 5,0$^\dagger$} & {\small 25 abril 2022} & {\small Correcciones menores} \\[0.8mm]
{\small 6,0$^\dagger$} & {\small 12 enero 2024} & {\small Correcciones menores} \\[0.8mm]
\end{tabular}
\end{table}
\vspace{0.3cm}
{\noindent \footnotesize {\normalsize $^\dagger$} versión disponible en SocArXiv ({\scriptsize DOI:} \href{https://doi.org/10.31235/osf.io/r4pj8}{\textcolor{blue}{10.31235/osf.io/r4pj8}}).}
