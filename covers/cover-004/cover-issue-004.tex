...
{\noindent \href{http://creativecommons.org/licenses/by/4.0/deed.es}{\includegraphics[width=0.115\linewidth]{../../img/by}} Algunos derechos reservados (2020) \\ Código bajo {\LaTeX} Project Public License v1.3c}

\justify\rightskip5.75cm{{\bfseries Tufte Working Papers (ISSN 2735-6043)} es una publicación continua basada en Training Data Lab con el apoyo logístico de la Universidad de Santiago de Chile (USACH). Esta serie de documentos promueve el debate en ciencias sociales, especialmente en temas relacionados con la ciencia política y las políticas públicas. La serie incluye trabajos inéditos y versiones revisadas de publicaciones previas que proponen técnicas de investigación innovadoras u ofrecen información empírica novedosa. Los trabajos se publican en español e inglés, aunque se privilegian las publicaciones en español con el fin de apoyar la difusión del conocimiento de acceso abierto en Iberoamérica.}
...
{\noindent Bastián González-Bustamante}\\
...
{\noindent Antonia Rebolledo}\\
{\noindent {\Large \Letter} \href{mailto:antonia.rebolledo@training-datalab.com}{antonia.rebolledo@training-datalab.com}}
