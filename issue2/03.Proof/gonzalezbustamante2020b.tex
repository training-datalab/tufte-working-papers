...
~\vfill
{\noindent \bfseries Nro. \textcolor{red}{TBC} | 2020}\\
{\noindent González-Bustamante, B. (2020). Sofisticación, participación y compromiso político en América Latina. {\itshape Tufte Working Papers}, \textcolor{red}{(TBC)}, 1-\textcolor{red}{TBC}. {\scshape doi:} \href{https://tuftepapers.com/2020/08/06/sofisticacion-politica-america-latina.html}{\textcolor{blue}{TBC}}}
\pagebreak
...
\captionsetup[subfigure]{labelformat=empty}
  ...
  \subfloat[VB2]{\includegraphics[width=.316\linewidth]{figures/conocim-part}}
  \subfloat[PROT3]{\includegraphics[width=.316\linewidth]{figures/conocim-prot}}
  \subfloat[EFF1]{\includegraphics[width=.316\linewidth]{figures/conocim-eff}}\\
   \subfloat[VB10]{\includegraphics[width=.316\linewidth]{figures/conocim-id-part}}
   \subfloat[POL1]{\includegraphics[width=.316\linewidth]{figures/conocim-int}}
   \subfloat[GI0]{\includegraphics[width=.316\linewidth]{figures/conocim-medios}}
  \\ \smallskip\noindent\scriptsize Fuente: Elaboración propia con datos del Barómetro de las Américas 2016/17 por LAPOP, \href{https://www.vanderbilt.edu/lapop/}{\textcolor{blue}{www.LapopSurveys.org}}.
\end{figure*}
...
\captionsetup[subfigure]{labelformat=empty}
  ...
  \subfloat[VB2]{\includegraphics[width=.316\linewidth]{figures/logit-part}}
  \subfloat[PROT3]{\includegraphics[width=.316\linewidth]{figures/logit-prot}}
  \subfloat[EFF1]{\includegraphics[width=.316\linewidth]{figures/logit-eff}}\\
   \subfloat[VB10]{\includegraphics[width=.316\linewidth]{figures/logit-id-part}}
   \subfloat[POL1]{\includegraphics[width=.316\linewidth]{figures/logit-int}}
   \subfloat[GI0]{\includegraphics[width=.316\linewidth]{figures/logit-medios}}
...
\captionsetup[subfigure]{labelformat=empty}
  ...
  \subfloat[VB2]{\includegraphics[width=.316\linewidth]{figures/margin-part}}
  \subfloat[PROT3]{\includegraphics[width=.316\linewidth]{figures/margin-prot}}
  \subfloat[EFF1]{\includegraphics[width=.316\linewidth]{figures/margin-eff}}\\
   \subfloat[VB10]{\includegraphics[width=.316\linewidth]{figures/margin-id-part}}
   \subfloat[POL1]{\includegraphics[width=.316\linewidth]{figures/margin-int}}
   \subfloat[GI0]{\includegraphics[width=.316\linewidth]{figures/margin-medios}}
...
\captionsetup[subfigure]{labelformat=empty}
  ...
  \subfloat[VB2]{\includegraphics[width=.316\linewidth]{figures/log-OR-part}}
  \subfloat[PROT3]{\includegraphics[width=.316\linewidth]{figures/log-OR-prot}}
  \subfloat[EFF1]{\includegraphics[width=.316\linewidth]{figures/log-OR-eff}}\\
   \subfloat[VB10]{\includegraphics[width=.316\linewidth]{figures/log-OR-id-part}}
   \subfloat[POL1]{\includegraphics[width=.316\linewidth]{figures/log-OR-int}}
   \subfloat[GI0]{\includegraphics[width=.316\linewidth]{figures/log-OR-medios}}
  \\ \smallskip\noindent\scriptsize Fuente: Elaboración propia con datos del Barómetro de las Américas 2016/17 por LAPOP, \href{https://www.vanderbilt.edu/lapop/}{\textcolor{blue}{www.LapopSurveys.org}}.
\end{figure*}
...
\captionsetup[subfigure]{labelformat=empty}
  ...
  \subfloat[VB2]{\includegraphics[width=.316\linewidth]{figures/random-part}}
  \subfloat[PROT3]{\includegraphics[width=.316\linewidth]{figures/random-prot}}
  \subfloat[EFF1]{\includegraphics[width=.316\linewidth]{figures/random-eff}}\\
   \subfloat[VB10]{\includegraphics[width=.316\linewidth]{figures/random-id-part}}
   \subfloat[POL1]{\includegraphics[width=.316\linewidth]{figures/random-int}}
   \subfloat[GI0]{\includegraphics[width=.316\linewidth]{figures/random-medios}}
  \\ \smallskip\noindent\scriptsize Fuente: Elaboración propia con datos del Barómetro de las Américas 2016/17 por LAPOP, \href{https://www.vanderbilt.edu/lapop/}{\textcolor{blue}{www.LapopSurveys.org}}.
\end{figure*}
...
\vspace{8mm}
{\noindent {\Large Rodrigo Cuevas}\footnote{Docente, Escuela de Postgrado, Instituto de Asuntos Públicos, Universidad de Chile. ORCID iD: \href{https://tuftepapers.com}{\textcolor{blue}{TBC}}} \\
{\normalsize Universidad de Chile} \\
\vspace{1mm}{\LARGE \Letter} \href{rodrigocuevas@uchile.cl}{\textcolor{blue}{\normalsize rodrigocuevas@uchile.cl}}}
\vspace{8mm}
