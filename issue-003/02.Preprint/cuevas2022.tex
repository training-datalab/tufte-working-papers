...
\begin{fullwidth}
\begin{equation}
Y_{Profundidad}= \beta_{0} + \beta_{Democracia}+ \beta_{Inversiones}+ \beta_{P. Intelectual}+\beta_{UE}+ \ \beta_{Per\'iodo}+ \epsilon
\end{equation}
\end{fullwidth}
...
\item{\small Bartolucci, F., Bacci, S., {\itshape \&} Gnaldi, M. (2016). Statistical Analysis of Questionnaires. New York: CRC PRESS / Taylor {\itshape \&} Francis Group.}
...
\item{\small DESTA (2022). Design of Trade Agreements (DESTA) Database. Disponible en: https://www.designoftradeagreements.org/downloads (consultado el 15 de julio de 2022).}
...
\item{\small Gelman, A., {\itshape \&} Hill, J. (2017). {\itshape Data Analysis Using Regression and Multilevel / Hierarchical Models (17th printing)}. New York: Cambridge University Press.}
...
\item{\small Harrel, F. (2001). {\itshape Regression Modeling Strategies: with Applications to Linear Models, Logistic Regression, and Survival Analysis}. New York: Springer.}
