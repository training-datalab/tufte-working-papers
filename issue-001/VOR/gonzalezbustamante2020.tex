...
\justify{El efecto para evitar solapamiento, por otra parte, mejora la visualización considerando el tama\~no de los {\itshape nodos} y su distancia $d^{`} (n_{1}, n_{2}) = d (n_{1}, n_{2}) - size(n_{1}) - size(n_{2})$. Si $d^{`} (n_{1}, n_{2}) > 0$ no hay solapamiento, por lo cual se utiliza la ecuaci\'on de repulsi\'on normal. Sin embargo, si $d^{`} (n_{1}, n_{2}) < 0$, entonces $F_{\alpha} (n_{1}, n_{2}) = 0$ y la repulsi\'on ser\'a m\'as fuerte (6) (Jacomy et al., 2014).}
...
{\small 8,0$^\dagger$} & {\small 4 enero 2024} & {\small Correcciones menores} \\
\end{tabular}
\end{table}
\vspace{0.3cm}
