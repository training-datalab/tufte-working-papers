...
\includepdf[pages=1]{../../covers/cover-1/cover-issue-1.pdf}
\includepdf[pages=2]{../../covers/cover-1/cover-issue-1.pdf}
...
{\noindent González-Bustamante, B., {\itshape \&} Cisternas, C. (2020). Aplicación de ForceAtlas2, un algoritmo de diseño gráfico continúo, para el estudio de las élites. {\itshape Tufte Working Papers}, (1), 1-15. {\scshape url:} \href{https://tuftepapers.com/2020/08/aplicacion-de-ForceAtlas2-algoritmo-de-diseno-grafico.html}{\textcolor{blue}{https://tuftepapers.com}}. {\scshape {\footnotesize SocArXiv} doi:} \href{https://doi.org/10.31235/osf.io/gxrkc}{\textcolor{blue}{10.31235/osf.io/gxrkc}}}\pagebreak
...
\justify{Efectivamente, el SNA permite observar vínculos y medir interrelaciones en un grupo (Cisternas y Vásquez, 2018; González-Bustamante y Cisternas, 2016). En este contexto, es una técnica con diversas aplicaciones en el campo de la sociología y, en menor medida, en la ciencia política. También se utiliza bastante en análisis bibliométricos para evaluar la relación entre estructuras sociales, la referenciación y coautorías (Cronin y Shaw, 2002; Cisternas y González-Bustamante, 2016; White, 2001).}
...
\justify{El objetivo principal de este trabajo es demostrar que introduciendo mejoras como el uso del algoritmo ForceAtlas2 y algunos ajustes específicos en su configuración es posible realizar un análisis más específico de las conexiones y la confirmación de conglomerados en un grupo, en este caso en la élite legislativa. Esto permite una evaluación visual más intuitiva de los niveles de homogeneidad y cierre social. Para cumplir con este objetivo, este documento se estructura en tres apartados. Primero, un apartado metodol\'ogico que detalla los datos y algoritmos usados. Segundo, los principales resultados de la aplicaci\'on de ForceAtlas2. Finalmente, un breve resumen de los principales hallazgos y l\'ineas futuras de investigaci\'on.}
